...
//        System.out.println();
        ...
        System.out.println(map.put(11,"orange"));// есл нет ключа - + новая пара
        System.out.println(map.put(11,"green"));// если есть будет переписывание
        //replace(K key , V value) - если ключа нет новая пара не создаёться
        System.out.println(map.replace(200,"red"));
        //если ключ есть значение будут переписаны
        ...
        //foreach() - перебор всех пар ключ-значение с возможностью применить к ним какуюто функцию
