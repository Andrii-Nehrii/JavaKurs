...
public class MapEx {
    public static void main(String[] args) {
        ...
        // Map <K ,V>
        Map<Integer, String> pldTable = new Hashtable<>();//старая и медленная
        Map<String, String> phoneBook = new HashMap<>();
        System.out.println(phoneBook.put("Hanna" , "+49-1111111"));

        System.out.println(phoneBook.put("Max" , "+49-22222222222"));
        System.out.println(phoneBook.put("John" , "+49-33333333"));
        ...
        //V get(K key) - значение по ключу
        String value = phoneBook.get("Hanna");
        System.out.println( "String value = phoneBook.get(\"Hanna\"): " + value);
